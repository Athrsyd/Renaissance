...
const ContinueLearningCard = ({ item }) => {
    return (
        <div className={`px-10 py-5 ${item.id % 2 === 0 ? 'bg-bistre' : 'bg-beige'} p-4 rounded-lg min-w-70 sm:min-w-85 shrink-0 shadow-lg`}>
...
const ContinueLearning = () => {
    return (
        <div className="ContinueLearning flex flex-row gap-7 mx-5 my-10 justify-start items-stretch overflow-x-auto overflow-y-hidden pb-2">
            {data.map((item) => (
