    ...
    return (
        ...
        >
            <div className='w-full max-w-md md:max-w-xl rounded-3xl border-2 border-[#AF8D66] bg-[#5C4A47] px-4 py-5 sm:px-8 sm:py-8 text-[#F5EFE8] shadow-2xl'>
                <h2 className='text-center text-2xl sm:text-3xl font-semibold tracking-wide'>Membuat Komunitas Baru</h2>
                ...
                <form onSubmit={handleSubmit} className='mt-5 sm:mt-6'>
                    <div className='flex flex-col items-center'>
                        <button
                            ...
                            className='h-20 w-20 sm:h-24 sm:w-24 rounded-full bg-bistre  flex items-center justify-center hover:opacity-90 transition duration-300'
                            aria-label='Choose photo'
                        >
                            <Users size={42} color='#f2e0d2' />
                        </button>
                    ...
                    <div className='mt-5 sm:mt-6'>
                        ...
                        <input
                            ...
                            className='w-full rounded-2xl border border-icon bg-[#7B645A] px-6 py-4 text-xl  text-[#E9DED2] placeholder:text-[#CDB9A4] outline-none focus:border-coffe'
                            disabled={isLoading}
                            required
                            autoComplete='off'
                        />
                    ...
                    <div className='mt-5 sm:mt-7 flex justify-center'>
                        <button
                            type='submit'
                            disabled={isLoading}
                            className='w-full max-w-xs rounded-2xl bg-[#AF8D66] px-6 py-3 text-xl font-semibold text-[#F8F4EF] hover:bg-[#C39E74] transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed'
                        >
                            {isLoading ? 'Membuat...' : 'Buat Komunitas'}
                        </button>
                    </div>
