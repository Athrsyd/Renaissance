    ...
    <>
      <div className="relative bg-[#F2E0D2] w-94 lg:w-225 mt-5 mx-auto p-5 lg:py-12 lg:px-10 rounded-2xl">
        <div className="flex flex-col px-0 lg:px-2 w-[70%] gap-2">
          ...
          <p className="text-md w-90 lg:w-140 font-semibold mt-2 pr-10 text-[#39221C]">
          ...
          <button className= "hover:scale-105 transition duration-300 ease-in-out bg-bistre text-white self-start mt-2 px-4 py-2 text-[14px] lg:text-[13px] rounded-xl">
            Learn More
          </button>
        </div>
