  ...
  return (
    <>
      <div className="group transition-all duration-500 hover:-translate-y-2 cursor-pointer w-85 h-70 lg:w-50 lg:h-70 md:w-50 md:h-70 justify-center rounded-2xl py-4 bg-bistre relative flex-col ">
        ...
        <Link to="/academy">
          <button className="hover:bg-bistre transition-all duration-300 ease-in-out absolute z-40 text-[12px] lg:text-[8px] md:text-[8px] bottom-0 left-21 lg:left-8.5 mb-5 text-white px-8 py-2 rounded-lg shadow-md bg-black/20 border-white/20">
            Pelajari sekarang
          </button>
        </Link>
      </div>
