...
const CommunityList = () => {
    ...
    return (
        <div className="community-list-container p-4  bg-bistre w-225 mx-auto text-beige rounded-2xl mt-6 ">
            <div className="title text-2xl text-center font-semibold px-25 py-4">
            ...
            <div className="community-list">
                {communities.map((community) => (
                    ...
                    <div className="community-item flex flex-row px-10 justify-between items-center p-4 bg-white text-bistre rounded-lg mt-4">
